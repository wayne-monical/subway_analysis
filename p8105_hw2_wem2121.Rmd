...
2) The data will be joined by the names of the bakers, their series, and their episode. Therefore we need to standardize the names of these three variables by renaming the `baker_name` column to `baker` in the `bakers` data frame. 
